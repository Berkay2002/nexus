...
📖 [View in docs](https://reference.langchain.com/javascript/langchain-google)
...
This package will be replacing the [ChatGoogleGenerativeAI](https://github.com/langchain-ai/langchainjs/tree/2301260ae90ead5c5f725c8dae1487b6722607e2/libs/providers/langchain-google/google_generative_ai)
and [ChatVertex](https://github.com/langchain-ai/langchainjs/tree/2301260ae90ead5c5f725c8dae1487b6722607e2/libs/providers/langchain-google/google_vertex_ai) libraries.
...
- [`ChatGoogle`](https://reference.langchain.com/javascript/langchain-google/index/ChatGoogle)
- [`GoogleRequestCallbackHandler`](https://reference.langchain.com/javascript/langchain-google/index/GoogleRequestCallbackHandler)
- [`GoogleRequestLogger`](https://reference.langchain.com/javascript/langchain-google/index/GoogleRequestLogger)
- [`GoogleRequestRecorder`](https://reference.langchain.com/javascript/langchain-google/index/GoogleRequestRecorder)
- [`ChatGoogle`](https://reference.langchain.com/javascript/langchain-google/node/ChatGoogle)
- [`GoogleRequestCallbackHandler`](https://reference.langchain.com/javascript/langchain-google/node/GoogleRequestCallbackHandler)
- [`GoogleRequestLogger`](https://reference.langchain.com/javascript/langchain-google/node/GoogleRequestLogger)
- [`GoogleRequestRecorder`](https://reference.langchain.com/javascript/langchain-google/node/GoogleRequestRecorder)

## Interfaces

- [`ChatGoogleCallOptions`](https://reference.langchain.com/javascript/langchain-google/index/ChatGoogleCallOptions)
- [`ChatGoogleParams`](https://reference.langchain.com/javascript/langchain-google/index/ChatGoogleParams)
- [`GoogleCustomEventInfo`](https://reference.langchain.com/javascript/langchain-google/index/GoogleCustomEventInfo)
- [`ChatGoogleParams`](https://reference.langchain.com/javascript/langchain-google/node/ChatGoogleParams)
- [`GoogleCustomEventInfo`](https://reference.langchain.com/javascript/langchain-google/node/GoogleCustomEventInfo)
