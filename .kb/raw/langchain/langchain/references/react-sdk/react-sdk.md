...
📖 [View in docs](https://reference.langchain.com/javascript/langchain-react)
...
- [`FetchStreamTransport`](https://reference.langchain.com/javascript/langchain-react/FetchStreamTransport)
- [`SubagentManager`](https://reference.langchain.com/javascript/langchain-react/SubagentManager)

## Functions

- [`calculateDepthFromNamespace()`](https://reference.langchain.com/javascript/langchain-react/calculateDepthFromNamespace)
- [`createSuspenseCache()`](https://reference.langchain.com/javascript/langchain-react/createSuspenseCache)
- [`executeHeadlessTool()`](https://reference.langchain.com/javascript/langchain-react/executeHeadlessTool)
- [`extractParentIdFromNamespace()`](https://reference.langchain.com/javascript/langchain-react/extractParentIdFromNamespace)
- [`extractToolCallIdFromNamespace()`](https://reference.langchain.com/javascript/langchain-react/extractToolCallIdFromNamespace)
...
- [`invalidateSuspenseCache()`](https://reference.langchain.com/javascript/langchain-react/invalidateSuspenseCache)
- [`isHeadlessToolInterrupt()`](https://reference.langchain.com/javascript/langchain-react/isHeadlessToolInterrupt)
- [`isSubagentNamespace()`](https://reference.langchain.com/javascript/langchain-react/isSubagentNamespace)
...
- [`AgentTypeConfigLike`](https://reference.langchain.com/javascript/langchain-react/AgentTypeConfigLike)
- [`BaseStream`](https://reference.langchain.com/javascript/langchain-react/BaseStream)
- [`CompiledSubAgentLike`](https://reference.langchain.com/javascript/langchain-react/CompiledSubAgentLike)
- [`DeepAgentTypeConfigLike`](https://reference.langchain.com/javascript/langchain-react/DeepAgentTypeConfigLike)
...
- [`QueueEntry`](https://reference.langchain.com/javascript/langchain-react/QueueEntry)
- [`QueueInterface`](https://reference.langchain.com/javascript/langchain-react/QueueInterface)
- [`SubAgentLike`](https://reference.langchain.com/javascript/langchain-react/SubAgentLike)
- [`SubagentStreamInterface`](https://reference.langchain.com/javascript/langchain-react/SubagentStreamInterface)
- [`SubagentToolCall`](https://reference.langchain.com/javascript/langchain-react/SubagentToolCall)
- [`ToolEvent`](https://reference.langchain.com/javascript/langchain-react/ToolEvent)
- [`UseAgentStream`](https://reference.langchain.com/javascript/langchain-react/UseAgentStream)
- [`UseAgentStreamOptions`](https://reference.langchain.com/javascript/langchain-react/UseAgentStreamOptions)
- [`UseDeepAgentStream`](https://reference.langchain.com/javascript/langchain-react/UseDeepAgentStream)
- [`UseDeepAgentStreamOptions`](https://reference.langchain.com/javascript/langchain-react/UseDeepAgentStreamOptions)
- [`UseStream`](https://reference.langchain.com/javascript/langchain-react/UseStream)
- [`UseStreamOptions`](https://reference.langchain.com/javascript/langchain-react/UseStreamOptions)
- [`UseStreamThread`](https://reference.langchain.com/javascript/langchain-react/UseStreamThread)
- [`UseStreamTransport`](https://reference.langchain.com/javascript/langchain-react/UseStreamTransport)

## Types

- [`AnyHeadlessToolImplementation`](https://reference.langchain.com/javascript/langchain-react/AnyHeadlessToolImplementation)
- [`BaseSubagentState`](https://reference.langchain.com/javascript/langchain-react/BaseSubagentState)
- [`ClassSubagentStreamInterface`](https://reference.langchain.com/javascript/langchain-react/ClassSubagentStreamInterface)
- [`DefaultSubagentStates`](https://reference.langchain.com/javascript/langchain-react/DefaultSubagentStates)
- [`DefaultToolCall`](https://reference.langchain.com/javascript/langchain-react/DefaultToolCall)
- [`ExtractAgentConfig`](https://reference.langchain.com/javascript/langchain-react/ExtractAgentConfig)
- [`ExtractDeepAgentConfig`](https://reference.langchain.com/javascript/langchain-react/ExtractDeepAgentConfig)
- [`ExtractSubAgentMiddleware`](https://reference.langchain.com/javascript/langchain-react/ExtractSubAgentMiddleware)
- [`GetToolCallsType`](https://reference.langchain.com/javascript/langchain-react/GetToolCallsType)
- [`InferAgentToolCalls`](https://reference.langchain.com/javascript/langchain-react/InferAgentToolCalls)
- [`InferBag`](https://reference.langchain.com/javascript/langchain-react/InferBag)
- [`InferDeepAgentSubagents`](https://reference.langchain.com/javascript/langchain-react/InferDeepAgentSubagents)
- [`InferNodeNames`](https://reference.langchain.com/javascript/langchain-react/InferNodeNames)
- [`InferStateType`](https://reference.langchain.com/javascript/langchain-react/InferStateType)
- [`InferSubagentByName`](https://reference.langchain.com/javascript/langchain-react/InferSubagentByName)
- [`InferSubagentNames`](https://reference.langchain.com/javascript/langchain-react/InferSubagentNames)
- [`InferSubagentState`](https://reference.langchain.com/javascript/langchain-react/InferSubagentState)
...
- [`IsAgentLike`](https://reference.langchain.com/javascript/langchain-react/IsAgentLike)
- [`IsDeepAgentLike`](https://reference.langchain.com/javascript/langchain-react/IsDeepAgentLike)
...
- [`ResolveStreamInterface`](https://reference.langchain.com/javascript/langchain-react/ResolveStreamInterface)
- [`ResolveStreamOptions`](https://reference.langchain.com/javascript/langchain-react/ResolveStreamOptions)
...
- [`SubagentStateMap`](https://reference.langchain.com/javascript/langchain-react/SubagentStateMap)
- [`SubagentStatus`](https://reference.langchain.com/javascript/langchain-react/SubagentStatus)
- [`SubagentStream`](https://reference.langchain.com/javascript/langchain-react/SubagentStream)
- [`SuspenseCache`](https://reference.langchain.com/javascript/langchain-react/SuspenseCache)
...
- [`UseStreamCustom`](https://reference.langchain.com/javascript/langchain-react/UseStreamCustom)
- [`UseStreamCustomOptions`](https://reference.langchain.com/javascript/langchain-react/UseStreamCustomOptions)
- [`UseSuspenseStream`](https://reference.langchain.com/javascript/langchain-react/UseSuspenseStream)
