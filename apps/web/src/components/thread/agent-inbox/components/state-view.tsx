    ...
    <div className="flex flex-row gap-2 items-start justify-start relative text-sm">
      ...
      >
        <div
          ...
          className="w-5 h-5 flex items-center justify-center hover:bg-muted text-muted-foreground hover:text-black rounded-md transition-colors ease-in-out cursor-pointer"
        >
