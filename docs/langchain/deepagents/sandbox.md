...
```typescript theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}} theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}} theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}} theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}} theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}}
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
  ...
  <a href="/oss/javascript/integrations/providers/deno" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline">
    <img className="block dark:hidden w-5 h-5" src="https://mintcdn.com/langchain-5e9cc07a/Tz8fh3A43FeUPf69/images/providers/light/deno.svg?fit=max&auto=format&n=Tz8fh3A43FeUPf69&q=85&s=8d213b0000104542fcaa7ab160595224" alt="" width="24" height="24" data-path="images/providers/light/deno.svg" />

    <img className="hidden dark:block w-5 h-5" src="https://mintcdn.com/langchain-5e9cc07a/Tz8fh3A43FeUPf69/images/providers/dark/deno.svg?fit=max&auto=format&n=Tz8fh3A43FeUPf69&q=85&s=4b80fd3f87be74cae919c9e847bedc8e" alt="" width="24" height="24" data-path="images/providers/dark/deno.svg" />
  ...
  <a href="/oss/javascript/integrations/providers/node-vfs" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline">
    <img className="block dark:hidden w-5 h-5" src="https://mintcdn.com/langchain-5e9cc07a/Tz8fh3A43FeUPf69/images/providers/light/nodejs.svg?fit=max&auto=format&n=Tz8fh3A43FeUPf69&q=85&s=f6703ac234d0889b8a8f15a9f5732340" alt="" width="24" height="24" data-path="images/providers/light/nodejs.svg" />

    <img className="hidden dark:block w-5 h-5" src="https://mintcdn.com/langchain-5e9cc07a/Tz8fh3A43FeUPf69/images/providers/dark/nodejs.svg?fit=max&auto=format&n=Tz8fh3A43FeUPf69&q=85&s=3acaceeca47ec35f72a8d3e764712168" alt="" width="24" height="24" data-path="images/providers/dark/nodejs.svg" />
