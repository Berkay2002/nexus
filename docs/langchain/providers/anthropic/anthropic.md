...
📖 [View in docs](https://reference.langchain.com/javascript/langchain-anthropic)
...
- [`ChatAnthropic`](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropic)
- [`ChatAnthropicMessages`](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropicMessages)

## Functions

- [`convertPromptToAnthropic()`](https://reference.langchain.com/javascript/langchain-anthropic/convertPromptToAnthropic)

## Interfaces

- [`AnthropicCacheControl`](https://reference.langchain.com/javascript/langchain-anthropic/AnthropicCacheControl)
- [`AnthropicInput`](https://reference.langchain.com/javascript/langchain-anthropic/AnthropicInput)
- [`Bash20250124Options`](https://reference.langchain.com/javascript/langchain-anthropic/Bash20250124Options)
- [`ChatAnthropicCallOptions`](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropicCallOptions)
- [`CodeExecution20250825Options`](https://reference.langchain.com/javascript/langchain-anthropic/CodeExecution20250825Options)
- [`Computer20250124Options`](https://reference.langchain.com/javascript/langchain-anthropic/Computer20250124Options)
- [`Computer20251124Options`](https://reference.langchain.com/javascript/langchain-anthropic/Computer20251124Options)
- [`MCPToolsetOptions`](https://reference.langchain.com/javascript/langchain-anthropic/MCPToolsetOptions)
- [`MemoryTool20250818Options`](https://reference.langchain.com/javascript/langchain-anthropic/MemoryTool20250818Options)
- [`TextEditor20250728Options`](https://reference.langchain.com/javascript/langchain-anthropic/TextEditor20250728Options)
- [`ToolSearchOptions`](https://reference.langchain.com/javascript/langchain-anthropic/ToolSearchOptions)
- [`WebFetch20250910Options`](https://reference.langchain.com/javascript/langchain-anthropic/WebFetch20250910Options)
- [`WebSearch20250305Options`](https://reference.langchain.com/javascript/langchain-anthropic/WebSearch20250305Options)

## Types

- [`AnthropicMessagesModelId`](https://reference.langchain.com/javascript/langchain-anthropic/AnthropicMessagesModelId)
- [`Bash20250124Command`](https://reference.langchain.com/javascript/langchain-anthropic/Bash20250124Command)
- [`Bash20250124ExecuteCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Bash20250124ExecuteCommand)
- [`Bash20250124RestartCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Bash20250124RestartCommand)
- [`ChatAnthropicContentBlock`](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropicContentBlock)
- [`ChatAnthropicInput`](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropicInput)
- [`Computer20250124Action`](https://reference.langchain.com/javascript/langchain-anthropic/Computer20250124Action)
- [`Computer20251124Action`](https://reference.langchain.com/javascript/langchain-anthropic/Computer20251124Action)
- [`ComputerDoubleClickAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerDoubleClickAction)
- [`ComputerHoldKeyAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerHoldKeyAction)
- [`ComputerKeyAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerKeyAction)
- [`ComputerLeftClickAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerLeftClickAction)
- [`ComputerLeftClickDragAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerLeftClickDragAction)
- [`ComputerLeftMouseDownAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerLeftMouseDownAction)
- [`ComputerLeftMouseUpAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerLeftMouseUpAction)
- [`ComputerMiddleClickAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerMiddleClickAction)
- [`ComputerMouseMoveAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerMouseMoveAction)
- [`ComputerRightClickAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerRightClickAction)
- [`ComputerScreenshotAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerScreenshotAction)
- [`ComputerScrollAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerScrollAction)
- [`ComputerTripleClickAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerTripleClickAction)
- [`ComputerTypeAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerTypeAction)
- [`ComputerUseReturnType`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerUseReturnType)
- [`ComputerWaitAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerWaitAction)
- [`ComputerZoomAction`](https://reference.langchain.com/javascript/langchain-anthropic/ComputerZoomAction)
- [`Memory20250818Command`](https://reference.langchain.com/javascript/langchain-anthropic/Memory20250818Command)
- [`Memory20250818CreateCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Memory20250818CreateCommand)
- [`Memory20250818DeleteCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Memory20250818DeleteCommand)
- [`Memory20250818InsertCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Memory20250818InsertCommand)
- [`Memory20250818RenameCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Memory20250818RenameCommand)
- [`Memory20250818StrReplaceCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Memory20250818StrReplaceCommand)
- [`Memory20250818ViewCommand`](https://reference.langchain.com/javascript/langchain-anthropic/Memory20250818ViewCommand)
- [`MemoryTool20250818`](https://reference.langchain.com/javascript/langchain-anthropic/MemoryTool20250818)
- [`TextEditor20250728Command`](https://reference.langchain.com/javascript/langchain-anthropic/TextEditor20250728Command)
- [`TextEditor20250728CreateCommand`](https://reference.langchain.com/javascript/langchain-anthropic/TextEditor20250728CreateCommand)
- [`TextEditor20250728InsertCommand`](https://reference.langchain.com/javascript/langchain-anthropic/TextEditor20250728InsertCommand)
- [`TextEditor20250728StrReplaceCommand`](https://reference.langchain.com/javascript/langchain-anthropic/TextEditor20250728StrReplaceCommand)
- [`TextEditor20250728ViewCommand`](https://reference.langchain.com/javascript/langchain-anthropic/TextEditor20250728ViewCommand)
